...
def render_report_tab(meta, material, use_props, inputs, df_rows, overall_ok, governing, extras):
    ...
    st.table(mat_df)
    st.caption("Note: Partial safety factors are assumed included in the database capacities (γ = 1.0 in checks).")
    ...
    # small professional summary box
